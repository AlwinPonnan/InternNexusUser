...
export class StudentProjectEnrolled extends Component {
  static navigationOptions = {
    drawerLabel: "Projects Enrolled"
  }
  constructor(props) {
    super(props)
  ...
  goProject() {
    this.props.navigation.navigate('ProjectDashboard')
  }
  render() {
    return (
      <View>
        ...
        <ScrollView style={styles.MainBox}>
          ...
          <View>
            <Text style={styles.Head}>Projects Enrolled</Text>
          </View>
          ...
          <View style={styles.Tile}>
            <View>
              <TouchableOpacity onPress={() => this.goProject()}>
...
export default StudentProjectEnrolled
