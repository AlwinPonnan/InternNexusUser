...
class LoginComponent extends Component {
    ...
    componentWillMount() {
        SInfo.getItem("id", {
            ...
            if (value) {
                this.props.navigation.navigate("CpyDash")
            }
        })
    }
    ...
    // }
    login() {
        fetch("http://192.168.31.156:3000/mcomp/login", {
            method: "POST",
            headers: {
            ...
            .then(res => {
                ...
                if (res.message) {
                    ...
                    SInfo.setItem("id", res._id, {
                        sharedPreferencesName: "compSharedPrefs",
                        keychainService: "compKeychainService"
                    })
    ...
    goCpyRegister() {
        this.props.navigation.navigate("RegisterComponent")
    }
        ...
        return (
            ...
            <Image style={{height:35,width:35}} source={require('../../img/logog.png')} />
                ...
                <View style={styles.innerTextW}>
                    ...
                    />
                    <Text style={styles.welcomeText}>Company Login</Text>
                </View>
