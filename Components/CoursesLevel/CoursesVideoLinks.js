...
export default class CoursesVideoLinks extends Component {
  static navigationOptions = {
    drawerLabel: 'Video Links'
  }
    ...
    return (
      ...
      <View style={styles.container}>
        ...
        <ScrollView style={styles.MainBox}>
           ...
           <Text style={styles.TileHead}>Javascript arrays</Text>
           <TouchableOpacity >
                       <View style={styles.btn}>
                           <Text style={styles.btnText}>Link to Video</Text>
                       </View>
                   </TouchableOpacity>
           </View>
           ...
           <Text style={styles.TileHead}>Forms In Angular</Text>
           <TouchableOpacity >
                       <View style={styles.btn}>
                           <Text style={styles.btnText}>Link to Video</Text>
                       </View>
           ...
           <View style={styles.TileODD}>
            ...
            <Text style={styles.TileHead}>Angular Bindings</Text>
            <TouchableOpacity >
                        <View style={styles.btn}>
                            <Text style={styles.btnText}>Link to Video</Text>
                        </View>
